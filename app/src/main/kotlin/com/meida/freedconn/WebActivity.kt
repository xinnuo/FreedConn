...
class WebActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        init_title(getString(R.string.deal))

        OkGo.post<String>(BaseHttp.zcxy_center)
            ...
            .execute(object : StringDialogCallback(baseContext) {
                ...
                override fun onSuccessResponse(
                    ...
                    val str = "<!doctype html><html>\n" +
                            ...
                            ".con{ width:95%; margin:0 auto; color:#51ceff; padding:0.5em 0; overflow:hidden; display:block; font-size:0.92em; line-height:1.8em; }\n" +
