...
public class NetworkUtil {
    ...
    public static byte getCurrentNetType(Context context) {
        ...
        if (networkInfo != null) {
            ...
            if (TextUtils.isEmpty(typeName)) typeName = networkInfo.getTypeName();
    ...
    public static String getNetworkProxyInfo(Context context) {
        ...
        if (manager == null) return null;
            ...
            if (info != null) {
                ...
                if (typeName.equals("wifi")) return null;
            } else return null;
        }
    ...
    public static String getNetworkProxyUrl() {
         ...
         */
        if (curNetworkType == CURRENT_NETWORK_TYPE_WIFI) return null;
    ...
    public static String getSimOperator(Context context) {
        TelephonyManager tm = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) return tm.getSimOperator();
        return null;
    }

    public static String getNetworkOperator(Context context) {
        TelephonyManager tm = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) return tm.getNetworkOperator();
        return null;
    }
